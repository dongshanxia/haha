...
import cn.xuchenbing.teac.mapper.BaseMapper;
import cn.xuchenbing.teac.mapper.TeacherNavbarMapper;
import cn.xuchenbing.teac.mapper.UserMapper;

import cn.xuchenbing.teac.entity.Page;
import cn.xuchenbing.teac.service.BaseService;
...
public class BaseServiceImpl<T> implements BaseService<T> {
	...
	@Autowired
	protected  TeacherNavbarMapper teacherNavbarMapper;
	@Autowired
	...
	public List<T> selectResult(String userId) {
		...
		return baseMapper.selectResult(userId);
	}
